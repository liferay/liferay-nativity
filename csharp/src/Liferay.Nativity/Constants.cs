...
namespace Liferay.Nativity
{
	...
	public static class Constants
	{
		...
		public const string GET_CONTEXT_MENU_ITEMS = "getContextMenuList";
		
		public const string GET_FILE_ICON_ID = "getFileIconId";
		
		public const string ID = "id";
		
		public const string MENU_INDEX = "menuIndex";
		...
		public const string UNREGISTER_ICON = "unregisterIcon";
