...
namespace Liferay.Nativity.Modules.ContextMenu
{
	...
	/// <returns>each ContextMenuItem instance in the list will appear at the context menu's top level</returns>
	public delegate IEnumerable<Model.ContextMenuItem> ContextMenuControlCallback(IEnumerable<string> paths);
}
